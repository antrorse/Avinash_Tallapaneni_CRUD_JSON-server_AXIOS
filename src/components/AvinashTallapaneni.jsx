...
const AvinashTallapaneni = () => {
  return (
    <div className="w-screen h-10 flex justify-center items-center fixed bottom-0 text-slate-100 z-20  bg-slate-900  gap-4 fill-white">
      <svg
      ...
      <Link to="https://twitter.com/TallapaneniAvi" target="_blank">
        Coded by{" "}
        <span className="AvinashTallapaneni">
          {" "}
          Avinash Tallapaneni
        </span>
      </Link>
